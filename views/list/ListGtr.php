...
<table   class="table table-responsive table-bordered table-condensed">
    <tr  class="bg-info"  style="font-family: Calibri"><td colspan="6" style="text-align: center"><h4>Génie Telecomunication et Reseau </h4></td></tr>
...
<?php foreach($etudiantGtr as $data){?>
